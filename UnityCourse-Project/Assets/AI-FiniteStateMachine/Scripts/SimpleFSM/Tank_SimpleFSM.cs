...
public class Tank_SimpleFSM : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _patrolDestination = _waypointsManager.GetCurrentDestination().transform.position;
    ...
    public void CheckPatrol()
    {
        ...
        {
            _patrolDestination = _waypointsManager.GetNextPatrolDestination().transform.position;
        }
